<div class="col-span-6">
    <div class="flex col-span-6 sm:col-span-4">
        <div class="w-full">
            ...
            <x-input wire:model="seo.title" id="title" type="text" class="mt-1 block w-full"
                     placeholder="Ex: John Doe's personal website"
            />
            <x-input-error for="seo.title" class="mt-2"/>
        </div>
    </div>
    ...
    <div class="col-span-6 sm:col-span-4">
        ...
        <textarea wire:model="seo.description" name="description" id="description"
                  cols="30" rows="10"
        ...
        <x-input-error for="seo.description" class="mt-2"/>
    </div>
