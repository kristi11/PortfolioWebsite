<div class="flex items-center ml-12">
    <div class="">
        <x-danger-button wire:loading.class="opacity-50" wire:click="$toggle('showDeleteModal')" type="button"
    ...
    <div class="ml-2">
        <x-button wire:loading.class="opacity-50" wire:click="create" style="white-space: nowrap;" class="focus:ring
