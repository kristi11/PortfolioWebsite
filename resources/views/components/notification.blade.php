<div
     ...
     class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-300 fixed font-semibold mr-2 mt-2 p-6 right-0 rounded-lg shadow-xl text-gray-500 dark:text-gray-100 top-0 flex z-50"
>
    <div class="mr-2">
