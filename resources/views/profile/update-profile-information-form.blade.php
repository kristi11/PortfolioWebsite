...
<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select wire:model.defer="state.interest"
                    id="interest"
                    name="interest"
                    type="text"
                ...
                @foreach(Functions::JOBS as $value => $name)
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select wire:model="state.state"
                ...
                <optgroup label="North America">
                    @foreach(Functions::NORTH_AMERICAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
                <optgroup label="South America">
                    @foreach(Functions::SOUTH_AMERICAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
                <optgroup label="Europe">
                    @foreach(Functions::EUROPEAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
                <optgroup label="Asia">
                    @foreach(Functions::ASIAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
                <optgroup label="Africa">
                    @foreach(Functions::AFRICAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
                <optgroup label="Australia">
                    @foreach(Functions::AUSTRALIAN_STATES as $code => $name)
                        <option value="{{ $code }}">{{ $name }}</option>
                    @endforeach
                </optgroup>
